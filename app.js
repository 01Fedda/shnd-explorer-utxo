var express = require('express')
  , path = require('path')
  , shndcoinapi = require('bitcoin-node-api')
...
if (settings.heavy != true) {
  shndcoinapi.setAccess('only', ['getinfo', 'gethashespersec', 'getmininginfo','getdifficulty', 'getconnectioncount',
  ...
  */
  shndcoinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'gethashespersec', 'getdifficulty', 'getconnectioncount',
